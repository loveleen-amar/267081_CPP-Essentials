...
TEST(Account,ParameterizedConstructor) {
    Account a1(1001,"Loveleen",5000.0);
    EXPECT_EQ(1001,a1.getCustomerId());
    EXPECT_STREQ("Loveleen",a1.getCustomerName().c_str());
...
TEST(Account,CopyConstructor) {
    ...
    EXPECT_STREQ("Loveleen",a2.getCustomerName().c_str());
...
TEST(Account,DisplayTest) {
    Account a1(1001,"Loveleen",5000.0);
    std::string ExpectedOut="1001,Loveleen,5000\n";
